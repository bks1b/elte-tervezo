...
export const mapEntries = <T, U>(obj: Dict<T>, f: (x: [string, T]) => [string, U][]) =>
  Object.fromEntries(Object.entries(obj).flatMap(f));
...
export const intersects = ([l1, r1 = l1]: number[], [l2, r2 = l2]: number[], discrete = false) =>
